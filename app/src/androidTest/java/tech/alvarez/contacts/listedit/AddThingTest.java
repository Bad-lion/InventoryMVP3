...
public class AddThingTest {
    ...
    public void addPersonTest() {
        ...
        onView(withId(R.id.supplierEditText)).check(matches(withText("La Paz, Bolivia")));
        onView(withId(R.id.priceEditText)).check(matches(withText("591 77242424")));
        onView(withId(R.id.quantityEditText)).check(matches(withText("daniel@alvarez.tech")));
    }
